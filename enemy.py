...
STAGE_1 = {"stage": 2, "hp_factor": 2, "attack" : 2, "defence": 2}
STAGE_2 = {"stage": 3, "hp_factor": 3, "attack" : 3, "defence": 3}
STAGE_3 = {"stage": 4, "hp_factor": 4, "attack" : 4, "defence": 4}
...
def generate_enemy(player: Player) -> Enemy:
    ...
    if player.drunk < 26:
        ...
        if rand > 90:
            return Enemy(player)
        return Enemy(player, params=STAGE_1)
...
def enemy_for_npc_quest(player: Player, exclude: list[dict] | None = None) -> Enemy:
    ...
    if 51 > player.drunk > 24:
        return Enemy(player, params=STAGE_1, exclude=exclude)
